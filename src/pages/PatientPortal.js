...
const PatientPortal = () => {
  ...
  const handleSearch = async () => {
    ...
    setError('');
    try {
      const response = await axios.post('http://localhost:8000/api/appointments/patient-portal', {
                ...
                <Card sx={{ mb: 3 }}>
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Welcome to your personal healthcare portal. View your upcoming and completed medical tests.
                    </Typography>
                  </CardContent>
                </Card>
                          ...
                          <Accordion key={index} sx={{ mb: 2 }}>
                            ...
                            <AccordionDetails>
                              <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} sm={6}>
                                  <Typography variant="body2" color="text.secondary">
                                    <strong>Room:</strong> {test.room_number || 'Not assigned'}
                                  </Typography>
                                  <Typography variant="body2" color="text.secondary">
                                    <strong>Assigned:</strong> {formatDateTime(test.assigned_at)}
                                  </Typography>
                                  {test.started_at && (
                                    <Typography variant="body2" color="text.secondary">
                            ...
                            <AccordionDetails>
                              <Grid container spacing={2}>
                                <Grid item xs={12} sm={6}>
                                  ...
                                  <Typography variant="body2" color="text.secondary">
                                    <strong>Room:</strong> {test.room_number || 'N/A'}
                                  </Typography>
                                </Grid>
                                <Grid item xs={12} sm={6}>
                                  <Typography variant="body2" color="text.secondary">
                                  ...
                                  <Typography variant="body2" color="text.secondary">
                                    <strong>Completed:</strong> {formatDateTime(test.completed_at)}
                                  </Typography>
                                </Grid>
                                {test.notes && (
                                  <Grid item xs={12}>
          ...
          <Paper sx={{ p: 3, mb: 3 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <Typography variant="body2">Pending - Test scheduled</Typography>
              </Box>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <PlayIcon color="info" />
                <Typography variant="body2">In Progress - Test ongoing</Typography>
              </Box>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <CheckIcon color="success" />
                <Typography variant="body2">Completed - Test finished</Typography>
              </Box>
            </Box>
          </Paper>
