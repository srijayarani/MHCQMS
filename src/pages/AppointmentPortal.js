            ...
            {appointmentData && (
              <Box sx={{mt: 4}}>
                        ...
                        <Grid item xs={12} sm={6}>
                          <Box
                            ...
                            <Typography
                              ...
                              sx={{fontWeight: 'bold'}}>
                              {new Date(
                                appointmentData.next_appointment.appointment_date
                              ).toLocaleString()}
                            </Typography>
                          </Box>
                        </Grid>
                      ...
                      {appointmentData.estimated_wait_time && (
                        <Box sx={{mt: 2}}>
                          <Typography variant="body2" color="text.secondary">
                            Estimated Wait Time:{' '}
                            {appointmentData.estimated_wait_time} minutes
                          </Typography>
                        </Box>
                      )}
                      ...
                      <Box sx={{mt: 2}}>
                        <Chip
                          ...
                          color={getStatusColor(
                            appointmentData.next_appointment.status
                          )}
                          size="medium"
                        />
                      </Box>
                ...
                <Box
                  ...
                  <Typography variant="body2" color="text.secondary">
                    <strong>Note:</strong> Please arrive 15 minutes before your
                    scheduled appointment time. Bring your patient ID and any
                    required documents. If you need to reschedule or cancel,
      ...
      <Dialog
          ...
          <Box sx={{pt: 1}}>
            ...
            <TextField
              ...
              onChange={(e) =>
                setNewAppointment((prev) => ({
                  ...prev,
                  estimated_wait_time: parseInt(e.target.value),
                }))
              }
            />
          </Box>
        ...
        <DialogActions>
          ...
          <Button
            ...
            variant="contained"
            disabled={
              !newAppointment.room_id || !newAppointment.appointment_date
            }>
